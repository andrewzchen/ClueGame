...
public class CTest_BoardAdjTargetTests {
	...
	public static void setUp() {
		...
		board.setConfigFiles("src/Data/CTest_ClueLayout.csv", "src/Data/CTest_ClueLegend.txt");		
	...
	//	for (BoardCell test : targets) {
			//System.out.println("The boardcell has row " + test.getRow() + " and col " + test.getCol());
	//	}
